...
public class ss_facialRecognition extends WatsonService {

    public static final String SERVICE_NAME = "visual-recognition";
    public static final String SERVICE_URL_HOST ="https://gateway-a.watsonplatform.net/visual-recognition/api";
    public String appVersion;
    public ss_facialRecognition(String version)
    {
        super(version);
        //lets check wason endpoints
        if(getEndPoint()==null || getEndPoint().isEmpty())
        {
            setEndPoint(SERVICE_URL_HOST);
        }

        Validator.isTrue((version != null) && !version.isEmpty(), "version cannot be null.");
        //lets set the version to our version object
        this.appVersion = version;
    }

    public ss_facialRecognition(String version, String apiKey) {
        this(version);
        setApiKey(apiKey);
    }


    //lets check authentication to our watson ibm service with httpok
     ...
     */
    public ss_facialRecognition(String versionDate, IamOptions iamOptions) {
        this(versionDate);
    ...
    public ServiceCall<ClassifiedImages> classify(ClassifyOptions classifyOptions) {
        ...
        builder.query(VERSION, appVersion);
